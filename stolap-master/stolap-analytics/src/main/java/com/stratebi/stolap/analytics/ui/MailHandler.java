...
public class MailHandler {
	...
	public void send() {
		 ...
		 if (service.isValid()) {
			...
			String tempDetail = bundle.getString("stolap.mailserver.configNotValid");
			String tempSummary = bundle.getString("stolap.errorUppercase");
	...
	public void sendEmail(final IEmailConfiguration emailConfig) {
	    ...
	    try {
	        ...
	        Transport.send(msg);
 			...
 			FacesContext context = FacesContext.getCurrentInstance();				
			ResourceBundle bundle = context.getApplication().getResourceBundle( context, "msg");
			String tempDetail = bundle.getString("stolap.mailserver.emailSend");
			String tempSummary = bundle.getString("stolap.infoUppercase");
