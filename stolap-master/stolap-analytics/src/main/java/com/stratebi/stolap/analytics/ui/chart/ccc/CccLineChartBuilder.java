package com.stratebi.stolap.analytics.ui.chart.ccc;

import javax.faces.context.FacesContext;

import org.pivot4j.ui.chart.ChartRenderContext;

import com.stratebi.stolap.analytics.ui.chart.ccc.chart.CccLineChart;
 ...
 *
 */
public class CccLineChartBuilder extends AbstractCCCChartBuilder<CccLineChart> {

	public static String NAME = "ccc.Line";

	public CccLineChartBuilder(FacesContext context) {
		super(context);
	}
	...
	@Override
	protected CccLineChart createChart(ChartRenderContext context) {
		CccLineChart cccLineChart = new CccLineChart();
		return cccLineChart;
	}
