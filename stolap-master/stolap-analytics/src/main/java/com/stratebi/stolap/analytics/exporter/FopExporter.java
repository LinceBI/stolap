 ...
 * ====================================================================
 */
package com.stratebi.stolap.analytics.exporter;
...
import com.stratebi.stolap.analytics.state.RenderFormat;
...
public class FopExporter extends org.pivot4j.ui.fop.FopExporter {
	...
	public FopExporter(OutputStream out, String[] chartImg) {
		...
		arrowImagesURI.put("arrow-upred", imageToURI("/resources/stolap/images/table/arrow-rup.gif", "gif"));
		arrowImagesURI.put("arrow-upgreen", imageToURI("/resources/stolap/images/table/arrow-gup.gif", "gif"));
		arrowImagesURI.put("arrow-upblack", imageToURI("/resources/stolap/images/table/arrow-nup.gif", "gif"));

		arrowImagesURI.put("arrow-downred", imageToURI("/resources/stolap/images/table/arrow-down.gif", "gif"));
		arrowImagesURI.put("arrow-downgreen", imageToURI("/resources/stolap/images/table/arrow-gdown.gif", "gif"));
		arrowImagesURI.put("arrow-downblack", imageToURI("/resources/stolap/images/table/arrow-ndown.gif", "gif"));
		
		arrowImagesURI.put("arrow-pinred", imageToURI("/resources/stolap/images/table/arrow-red.gif", "gif"));
		arrowImagesURI.put("arrow-pingreen", imageToURI("/resources/stolap/images/table/arrow-green.gif", "gif"));
		arrowImagesURI.put("arrow-pinblack", imageToURI("/resources/stolap/images/table/arrow-black.gif", "gif"));
		arrowImagesURI.put("arrow-pinyellow", imageToURI("/resources/stolap/images/table/arrow-yellow.gif", "gif"));
		arrowImagesURI.put("arrow-pinblue", imageToURI("/resources/stolap/images/table/arrow-blue.gif", "gif"));
	}
