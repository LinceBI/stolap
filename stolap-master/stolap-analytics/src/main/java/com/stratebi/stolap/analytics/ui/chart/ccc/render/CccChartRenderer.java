package com.stratebi.stolap.analytics.ui.chart.ccc.render;
...
import com.stratebi.stolap.analytics.ui.chart.ccc.chart.CccChart;
    ...
    */
    ...
    public void encodeEnd(FacesContext context, UIComponent component) throws IOException {
        ...
        writer.write(
			...
			"window.stolap_pivotChartToCanvas = ( typeof window.stolap_pivotChartToCanvas != 'undefined' && window.stolap_pivotChartToCanvas instanceof Array ) ? window.stolap_pivotChartToCanvas : [];\n" +
            "window.stolap_pivotChartToCanvas.push ( function (canvas, cwidth, cheight) {" +
