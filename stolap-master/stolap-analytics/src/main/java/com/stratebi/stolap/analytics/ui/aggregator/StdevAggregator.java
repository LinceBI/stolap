 ...
 * ====================================================================
 */
package com.stratebi.stolap.analytics.ui.aggregator;
...
public class StdevAggregator extends AbstractAggregator {
	 ...
	 * @param measure
	 */
	public StdevAggregator(Axis axis, List<Member> members, Level level,
			Measure measure) {
