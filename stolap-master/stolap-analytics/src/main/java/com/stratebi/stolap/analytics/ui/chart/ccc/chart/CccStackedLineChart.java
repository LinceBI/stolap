...
public class CccStackedLineChart extends CccChart {
    public static final String COMPONENT_TYPE = "com.stratebi.stolap.analytics.ui.chart.ccc.CccStackedLineChart";
    private static final String DEFAULT_RENDERER = "com.stratebi.stolap.analytics.ui.chart.ccc.CccStackedLineChartRenderer";
