...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="*/faces-config:lifecycle[last()]">
		...
		<managed-bean>&cr;&tab;&tab;
			...
			<managed-bean-class>com.stratebi.stolap.pentaho.datasource.PentahoDataSourceManager</managed-bean-class>&cr;&tab;&tab;
			<managed-bean-scope>session</managed-bean-scope>&cr;&tab;
		</managed-bean>&cr;&tab;
		<managed-bean>&cr;&tab;&tab;
			<managed-bean-name>reportRepository</managed-bean-name>&cr;&tab;&tab;
			<managed-bean-class>com.stratebi.stolap.pentaho.repository.PentahoReportRepository</managed-bean-class>&cr;&tab;&tab;
			<managed-bean-scope>session</managed-bean-scope>&cr;&tab;
		</managed-bean>&cr;&tab;
		<managed-bean>&cr;&tab;&tab;
			<managed-bean-name>reportOpener</managed-bean-name>&cr;&tab;&tab;
			<managed-bean-class>com.stratebi.stolap.pentaho.ui.PentahoReportOpener</managed-bean-class>&cr;&tab;&tab;
