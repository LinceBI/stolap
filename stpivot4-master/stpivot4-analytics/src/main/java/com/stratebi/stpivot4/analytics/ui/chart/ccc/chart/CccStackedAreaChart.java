...
public class CccStackedAreaChart extends CccChart {
    public static final String COMPONENT_TYPE = "com.stratebi.stpivot4.analytics.ui.chart.ccc.CccStackedAreaChart";
    private static final String DEFAULT_RENDERER = "com.stratebi.stpivot4.analytics.ui.chart.ccc.CccStackedAreaChartRenderer";

    public CccStackedAreaChart() {
