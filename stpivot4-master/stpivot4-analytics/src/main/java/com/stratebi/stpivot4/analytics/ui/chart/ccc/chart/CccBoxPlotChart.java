...
public class CccBoxPlotChart extends CccChart {
    public static final String COMPONENT_TYPE =    "com.stratebi.stpivot4.analytics.ui.chart.ccc.CccBoxPlotChart";
    private static final String DEFAULT_RENDERER = "com.stratebi.stpivot4.analytics.ui.chart.ccc.CccBoxPlotChartRenderer";

    public CccBoxPlotChart() {
