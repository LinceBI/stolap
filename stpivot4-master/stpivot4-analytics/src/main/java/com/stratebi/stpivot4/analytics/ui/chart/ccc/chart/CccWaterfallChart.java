...
public class CccWaterfallChart extends CccChart {
    public static final String COMPONENT_TYPE = "com.stratebi.stpivot4.analytics.ui.chart.ccc.CccWaterfallChart";
    private static final String DEFAULT_RENDERER = "com.stratebi.stpivot4.analytics.ui.chart.ccc.CccWaterfallChartRenderer";

    public CccWaterfallChart() {
