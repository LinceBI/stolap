...
import org.pivot4j.analytics.graphene.Button;
import org.pivot4j.analytics.graphene.ReportPage;
import org.pivot4j.analytics.graphene.Tab;
import org.pivot4j.analytics.graphene.TabPanel;
import org.pivot4j.analytics.graphene.Toolbar;
import org.pivot4j.analytics.graphene.Tree;
import org.pivot4j.analytics.graphene.WorkbenchPage;

public class LayoutIT extends AbstractIntegrationTestCase {

	/*
	 * Actualizado para stpivot
	 */
	@Page
	...
	public void testPageTitle() {
		assertThat("Unexpected page title.", getDriver().getTitle(),
				is(equalTo("STPivot4 Sample Application")));
	}
