package com.stratebi.stpivot4.pentaho.content;
...
public class ReportContentGenerator extends BaseContentGenerator {
	...
	private static final long serialVersionUID = 7257491111400674425L;
	...
	public void createContent() throws ServletException, IOException {
		...
		request.getRequestDispatcher(
				"/plugin/stpivot4/faces/open.xhtml?editable=" + isEditable())
